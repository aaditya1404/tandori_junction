    ...
    return (
      <nav className="fixed w-full z-50 bg-black/50 backdrop-blur-md border-b border-zinc-800">
        <div className="w-full mx-auto px-6 h-20 flex items-center justify-around">
          ...
          <div className="hidden lg:block bg-orange-500 px-5 py-2 rounded-lg text-white">
            Login
          </div>
        </div>
      </nav>
        ...
        <div className="w-full mx-auto px-6 h-20 flex items-center justify-around">
          ...
          {user ? (
            <div className="relative hidden md:flex items-center gap-4">
              ...
              >
                🔔
                <span className="absolute -top-1 -right-1 bg-red-500 w-4 h-4 rounded-full" />
              </button>
              ...
              {showProfileMenu && (
                <div className="absolute top-16 right-0 w-72 bg-zinc-900 border border-zinc-800 rounded-2xl shadow-xl overflow-hidden">
                  <div className="p-4 border-b border-zinc-800">
                    <h3 className="font-semibold">
                      {user?.displayName}
                    </h3>
