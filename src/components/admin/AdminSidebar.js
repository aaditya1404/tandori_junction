...
//     return (
//         <aside className="w-48 bg-[#090909] border-r border-zinc-800 p-6 flex flex-col">
//             <div>
...
//             <button className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-red-500 transition">
//                 <LogOut size={20} />
